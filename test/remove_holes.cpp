...
//            {375, 376, 377, 378, 379, 380, 381, 382, 383, 384, 385, 386},
    ...
    // This one crashes
    IndexList last = { 387, 388, 389, 390, 391, 392 };

    // Try not to crash

    auto good = removeHoles(pointList, outer, works);
    //std::ofstream file("good.svg");
    //svg::writePolygon(file, pointList, good, {last});
    auto bad = removeHoles(pointList, good, {last});
}
